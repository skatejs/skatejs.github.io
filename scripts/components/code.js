...
import '../../../../bower_components/highlightjs/build/highlight.pack';
import '../../../../src/skate';
...
export default skate('skate-code', {
  created: function (element) {
    ...
    lines.forEach(function (line, index) {
      ...
      code.innerHTML = setIndentLength(indent) + hljs.highlight(element.getAttribute('lang') || 'html', line).value;
